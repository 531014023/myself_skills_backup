...
> 本目录包含 64 个 Claude Code 技能（Skills），覆盖投资研究、文档处理、思维框架、信息搜索、创意设计、开发工具等多个领域。
...
| [corp-history-insight](./corp-history-insight) | 企业史鉴·文化洞察 | 从企业历史中挖掘企业文化与治理基因。编年史形式梳理发展历程，关注管理层言行一致性、困难时期文化践行度，输出结构化HTML报告 |
| [mx-data](./mx-data) | 妙想金融数据 | 基于东方财富权威数据库的金融数据查询工具，支持行情、财务及关联关系数据 |
| [mx-moni](./mx-moni) | 妙想模拟组合 | 股票模拟组合管理系统，支持持仓查询、买卖操作、撤单、委托查询和历史成交查询 |
| [mx-search](./mx-search) | 妙想资讯搜索 | 基于东方财富妙想搜索能力，金融场景信源智能筛选，覆盖新闻、公告、研报、政策等 |
| [mx-xuangu](./mx-xuangu) | 妙想智能选股 | 基于行情指标、财务指标等条件筛选股票，支持行业/板块查询和成分股推荐 |
| [mx-zixuan](./mx-zixuan) | 妙想自选股管理 | 基于东方财富通行证账户的自选股管理，支持自然语言查询、添加、删除自选股 |
...
| [rag-skill](./rag-skill) | RAG知识库 | 连接rag-kb API进行知识库操作。支持上传/检索/删除文档、列出collection，是IMA知识库的CLI替代方案 |
...
| [history-to-video](./history-to-video) | 历史转视频 | 将企业史鉴HTML报告自动转化为"每天了解一家公司"短视频，支持字幕版和无字幕版 |
